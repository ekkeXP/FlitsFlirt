...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Flitsflirt.App.DangerousTrustProvider+DangerousTrustManager, Flitsflirt.App", DangerousTrustProvider_DangerousTrustManager.class, __md_methods);
	}
	...
	public DangerousTrustProvider_DangerousTrustManager ()
	{
		...
		if (getClass () == DangerousTrustProvider_DangerousTrustManager.class) {
			mono.android.TypeManager.Activate ("Flitsflirt.App.DangerousTrustProvider+DangerousTrustManager, Flitsflirt.App", "", this, new java.lang.Object[] {  });
		}
	}
